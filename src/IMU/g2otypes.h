...
/**
 * Edge between NAV states of two frames
 * Including PVR and bias of last frame, and PVR of current frame
 * PVR_{n+1} = f(PVR_{n},bias{n})
 * Example: [last frame, frame], [last KF, frame] and [1st KeyFrame of Local Window, its previous (fixed)KeyFrame]
 * All state will be optimized
 * See Raul 2016 Fig. 3
 */
...
/**
 * Edge between biases of two frames
 * bias_{n+1} = f(bias{n})
 * Example: [last frame, frame], [last KF, frame] and [1st KeyFrame of Local Window, its previous (fixed)KeyFrame]
 * Bias will be optimized
 * See Raul 2016 Fig. 3
 */
...
/**
 * Edge from map point to one frame's PVR (measurement is its' projection)
 * Both map point and PVR will be optimized
 * Used in GlobalBundleAdjustmentNavState() and LocalBundleAdjustmentNavState()
 */
...
/**
 * BaseUnaryEdge is a template class to model a unary hyper-edge, 
 * which can be used to represent a prior.
 * It requires to specify the types of the (single) vertex x_i, 
 * and type and dimension of the error e(x_k) as template parameters.
 */
/**
 * Edge from map point to one frame's PVR (measurement is its' projection)
 * Only pose (PVR) will be optimized
 * Used in PoseOptimization of [last frame, frame] and [last KF, frame]
 */
...
/**
 * Prior edge for last frame
 * Current PVR and bias will be optimized
 * Used in PoseOptimization of [last frame, frame]
 * See Raul 2016 equation (7) and (8)
 */
/**
...
///////////////////////////////////////////////
/// The following classes are NOT used anywhere! Just ignore them.
///////////////////////////////////////////////
// /**
...
// };
///////////////////////////////////////////////
/// The above classes are NOT used anywhere! Just ignore them.
///////////////////////////////////////////////

/**
 * Used in OptimizeInitialGyroBias()
 */
/**
